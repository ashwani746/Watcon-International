const Products = () => {
   ...
   const items = [
    ...
    { id: 11, name: "Desk Lamp", image: "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=300&h=300&fit=crop" },
    { id: 12, name: "Water Bottle", image: "https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=300&h=300&fit=crop" },
    { id: 13, name: "Notebook", image: "https://images.unsplash.com/photo-1517842645767-c639042777db?w=300&h=300&fit=crop" },
    { id: 14, name: "Pen Set", image: "https://images.unsplash.com/photo-1585366119957-e9730b6d0f60?w=300&h=300&fit=crop" },
    { id: 15, name: "Coffee Mug", image: "https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?w=300&h=300&fit=crop" },
    { id: 16, name: "Plant Pot", image: "https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=300&h=300&fit=crop" },
    { id: 17, name: "Wall Clock", image: "https://images.unsplash.com/photo-1563861826100-9cb868fdbe1c?w=300&h=300&fit=crop" },
    { id: 18, name: "Desk Organizer", image: "https://images.unsplash.com/photo-1611269154421-4e27233ac5c7?w=300&h=300&fit=crop" },
    { id: 19, name: "Table Fan", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop" },
    { id: 20, name: "Storage Box", image: "https://images.unsplash.com/photo-1600493572592-5ed44598b1eb?w=300&h=300&fit=crop" }
  ];
