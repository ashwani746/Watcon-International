    ...
    <section className="bg-amber-50 py-12 px-4 md:py-24 md:px-8 font-sans">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto">
          Noble Nautica delivers premium aquatic and wellness infrastructure for
          the world's most ambitious projects. With a portfolio of over 5,600
          solutions from AI enabled systems to seamless glass-edge pools we
          empower contractors, architects and developers with precision-
          engineered, visually striking and future-ready equipment. Trusted
          across Europe, the USA and growing markets such as the Indian
          subcontinent, China and Southeast Asia, we bring proven expertise and
          a commitment to simplifying complexity, ensuring every project
        ...
        <div className="bg-slate-700 p-8 md:p-16 rounded-xl shadow-2xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-blue-300/40 p-6 md:p-8 rounded-lg flex flex-col items-center justify-center text-slate-800">
              <svg
                className="w-16 h-16 mb-4 stroke-current"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="1"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M9 12l2 2 4-4m5.618-4.016A11.955 111.955 0 0112 2.944a11.955 11.955 0 014.382 17.02l-.582-.358a8 8 0 10-8.799 0l-.582.358A11.955 11.955 0 0112 2.944z"
                />
              </svg>
            ...
            <div className="bg-blue-300/40 p-6 md:p-8 rounded-lg flex flex-col items-center justify-center text-slate-800">
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M11.049 2.927c.3-.921 1.636-.921 1.936 0l2.556 7.846h8.212c.969 0 1.371 1.24.588 1.81l-6.643 4.836 2.556 7.846c.3.921-.755 1.688-1.543 1.111l-6.643-4.836-6.643 4.836c-.788.577-1.843-.19-1.543-1.111l2.556-7.846L.936 12.583c-.783-.57.175-1.81.588-1.81h8.212l2.556-7.846z"
                />
            ...
            <div className="bg-blue-300/40 p-6 md:p-8 rounded-lg flex flex-col items-center justify-center text-slate-800">
              ...
              >
                ...
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M10 13l-3 4M14 13l3 4M12 11V3"
                />
              </svg>
